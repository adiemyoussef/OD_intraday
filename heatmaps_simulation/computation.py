...
def compute_heatmap(args, type:str, df_book: pd.DataFrame, start_time:datetime, price:float, steps:float, range:float):
    ...
    prices = price_matrix(price, steps, range)
...
if __name__ == "__main__":
    ...
    #------- TRADINGVIEW DATA-------- #
    spx_data_raw = pd.read_csv('SPREADEX_SPX_20240725.csv')
    ...
    start_time = pd.Timestamp('07:00').time()
